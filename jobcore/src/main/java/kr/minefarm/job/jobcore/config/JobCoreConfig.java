...
public final class JobCoreConfig {
    ...
    public int getJobChangeCooldownDays() {
        return jobChangeCooldownDays;
    }

    public long getAsyncFlushIntervalTicks() {
        return asyncFlushIntervalTicks;
    }

    public int getAsyncShutdownTimeoutSeconds() {
        return asyncShutdownTimeoutSeconds;
    }

    public long getBaseExpRequired() {
        return baseExpRequired;
    }

    public boolean isBlockVanillaExpOrbs() {
        return blockVanillaExpOrbs;
    }
    ...
    public boolean isVelocitySupport() {
